...
var cnItems = {
    ...
    "Good luck": "祝你好运",
    "Grown trees": "种植树木",
    "Happy new year (sort of)": "新年快乐（有点）",
    "Hire workers": "雇佣工人",
    ...
    "[Shift + Click] to sell for 25 gold": "[Shift + 点击] 以出售获得 25 金币",
    "Back to game": "返回游戏",
    "Florists like nature. Incidentally, 1 tree will grow every week.": "花店喜欢大自然。 顺便说一下，每周会长出一棵树。",
    "Improves each chopping click by 100%.": "将每次斩波点击提高 100%。",
    "Improves each planting click by 100%.": "将每次种植点击提高 100%。",
    "Main menu": "主菜单",
